...
import { E as init_globalthis, T as globalthis_default } from "../_libs/lodash+unenv.mjs";
import { t as createMiddleware } from "./createMiddleware-CS1UMm1J.mjs";
import process from "node:process";
import { AsyncLocalStorage } from "node:async_hooks";
//#region node_modules/.nitro/vite/services/ssr/assets/server-DVxFFpso.js
init_globalthis();
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DGRc_A5T.mjs");
